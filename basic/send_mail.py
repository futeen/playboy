...
if __name__ == '__main__':
    send_mail(server='smtp.yeah.net', port=25, psw='', sender='', receivers=
    'nigulasikaiqi@yeah.net', subject='test_mail', body='send one email to you honey',
              attachments=r'', cc=None, bcc=None)
