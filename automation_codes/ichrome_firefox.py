...
def get_element_rect_chrome(attrMap=None, index=0, tagName=None, title=None, url=None, waitfor=WAIT_FOR):
    '''
       chrome获取元素的位置
             attrMap:元素属性
             index:搜索游标，暂时默认为0
    ...
    try:
        ...
        while True:
            ...
            if int(retCode) == 1:
                print('----------', return_data["x"], return_data["y"], return_data["width"],
                      return_data["height"])
                return return_data["x"], return_data["y"], return_data["width"], return_data["height"]
...
def get_element_rect_firefox(attrMap=None, index=0, tagName=None, title=None, url=None, waitfor=WAIT_FOR):
    '''
       firefox获取元素的位置
             attrMap:元素属性
             index:搜索游标，暂时默认为0
